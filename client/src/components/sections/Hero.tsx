...
const slides = [
  ...
  {
    image: assets.m_logo11,
    overlay: "bg-[#8B0000]/60",
    type: "logo", // 👈 special type
  },
];
...
const Hero = () => {
  ...
  return (
    <section className="relative h-[90vh] pt-16 overflow-hidden">
        ...
        <motion.img
          ...
          className={
            currentSlide.type === "logo"
              ? "absolute inset-0 m-auto w-[60%] md:w-[40%] h-auto object-contain"
              : `
                absolute inset-0
                w-full h-full
                object-contain
      ...
      {/* Overlay */}
      <div
        className={`absolute inset-0 ${currentSlide.overlay} flex items-center justify-center text-white px-6`}
      >
